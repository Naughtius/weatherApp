import allСities from "./city.list.min.json";
...
export default class openWeatherService {
   ...
   _transformCity = (city) => {
      ...
      return {
         ...
         temp_max: Math.round(k2c(city.main.temp_max)),
         temp_min: Math.round(k2c(city.main.temp_min)),
         feels_like: Math.round(k2c(city.main.feels_like)),
